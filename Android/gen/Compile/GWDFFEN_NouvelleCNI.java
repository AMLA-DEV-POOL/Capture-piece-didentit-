 ...
 * Classe Android : FEN_NouvelleCNI
...
public class GWDFFEN_NouvelleCNI extends WDFenetre
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs de FEN_NouvelleCNI
////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°1 de FEN_NouvelleCNI.CAM_ANCIENNE_CNI
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2367915044878703579l);

super.setChecksum("623447243");
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°2 de FEN_NouvelleCNI.LIB_SansNom1
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2367915044878834666l);

super.setChecksum("623568754");
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°3 de FEN_NouvelleCNI.BTN_R
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2367915044878965738l);

super.setChecksum("623700282");
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°4 de FEN_NouvelleCNI.LIB_SansNom2
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2367915044879096826l);

super.setChecksum("623830914");
...
super.setPositionInitiale(412, 118);

super.setTailleInitiale(126, 175);
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°5 de FEN_NouvelleCNI.BTN_Flottant
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2367915049174262074l);

super.setChecksum("624029323");
...
// 		bResSauvegarde = CaméraCapture(CAM_ANCIENNE_CNI,SysRepCarteStockage()+[fSep()]+"checktatoSV_IMG"+[fSep()]+"NouvelleCNI"+[fSep()]+"NouvelleCNI_AV_"+gsRefUtilisate+".jpeg",viCaptureImage,1)
vWD_bResSauvegarde.setValeur(WDAPICamera.videoCapture(mWD_CAM_ANCIENNE_CNI,WDAPISys.sysRepCarteStockage().opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("checktatoSV_IMG").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI_AV_").opPlus(vWD_gsRefUtilisate).opPlus(".jpeg").getString(),2,new WDEntier4(1)));

// 		SI bResSauvegarde = Vrai ALORS
if(vWD_bResSauvegarde.opEgal(true, 0))
{
// 			CNIAV = SysRepCarteStockage()+[fSep()]+"checktatoSV_IMG"+[fSep()]+"NouvelleCNI"+[fSep()]+"NouvelleCNI_AV_"+gsRefUtilisate+".jpeg"
vWD_CNIAV.setValeur(WDAPISys.sysRepCarteStockage().opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("checktatoSV_IMG").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI_AV_").opPlus(vWD_gsRefUtilisate).opPlus(".jpeg"));

// 			Info(EnregistrerImage(CNIAV,"NouvelleCNI_AV_"+gsRefUtilisate,"jpeg","NouvelleCNI",gsRefUtilisate))
WDAPIDialogue.info(GWDCPCOL_ProceduresGlobales.fWD_enregistrerImage(vWD_CNIAV,new WDChaineU("NouvelleCNI_AV_").opPlus(vWD_gsRefUtilisate),new WDChaineU("jpeg"),new WDChaineU("NouvelleCNI"),vWD_gsRefUtilisate).getString());
...
// 			LIB_positionIMG = "ARRIERE"
mWD_LIB_positionIMG.setValeur("ARRIERE");
...
// 		bResSauvegarde = CaméraCapture(CAM_ANCIENNE_CNI,SysRepCarteStockage()+[fSep()]+"checktatoSV_IMG"+[fSep()]+"NouvelleCNI"+[fSep()]+"NouvelleCNI_AR_"+gsRefUtilisate+".jpeg",viCaptureImage,1)
vWD_bResSauvegarde.setValeur(WDAPICamera.videoCapture(mWD_CAM_ANCIENNE_CNI,WDAPISys.sysRepCarteStockage().opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("checktatoSV_IMG").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI_AR_").opPlus(vWD_gsRefUtilisate).opPlus(".jpeg").getString(),2,new WDEntier4(1)));

// 		SI bResSauvegarde = Vrai ALORS
if(vWD_bResSauvegarde.opEgal(true, 0))
{
// 			CNIAR = SysRepCarteStockage()+[fSep()]+"checktatoSV_IMG"+[fSep()]+"NouvelleCNI"+[fSep()]+"NouvelleCNI_AR_"+gsRefUtilisate+".jpeg"
vWD_CNIAR.setValeur(WDAPISys.sysRepCarteStockage().opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("checktatoSV_IMG").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI").opPlus(new WDChaineOptionnelle(WDAPIFichier.fSep())).opPlus("NouvelleCNI_AR_").opPlus(vWD_gsRefUtilisate).opPlus(".jpeg"));

// 			Info(EnregistrerImage(CNIAR,"NouvelleCNI_AR_"+gsRefUtilisate,"jpeg","NouvelleCNI",gsRefUtilisate))
WDAPIDialogue.info(GWDCPCOL_ProceduresGlobales.fWD_enregistrerImage(vWD_CNIAR,new WDChaineU("NouvelleCNI_AR_").opPlus(vWD_gsRefUtilisate),new WDChaineU("jpeg"),new WDChaineU("NouvelleCNI"),vWD_gsRefUtilisate).getString());
...
// 				LIB_positionIMG			= "AVANT"
mWD_LIB_positionIMG.setValeur("AVANT");
 ...
 * LIB_positionIMG
 */
class GWDLIB_positionIMG extends WDLibelle
{

////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°6 de FEN_NouvelleCNI.LIB_positionIMG
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2367915049174393146l);

super.setChecksum("624159939");

super.setNom("LIB_positionIMG");
...
super.setPositionInitiale(427, 35);

super.setTailleInitiale(89, 22);
...
public GWDLIB_positionIMG mWD_LIB_positionIMG;
...
////////////////////////////////////////////////////////////////////////////
// Déclaration des champs du fils n°7 de FEN_NouvelleCNI.LIB_enregistrement_en_cours
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.initialiserObjet();
super.setFenetre( getWDFenetreThis() );
super.setQuid(2368535448562181231l);

super.setChecksum("576119864");
...
super.setPositionInitiale(199, 179);

super.setTailleInitiale(220, 19);
...
/**
 * Traitement: Déclarations globales de FEN_NouvelleCNI
 */
...
////////////////////////////////////////////////////////////////////////////
// Création des champs de la fenêtre FEN_NouvelleCNI
////////////////////////////////////////////////////////////////////////////
...
mWD_LIB_positionIMG = new GWDLIB_positionIMG();
mWD_LIB_enregistrement_en_cours = new GWDLIB_enregistrement_en_cours();

}
////////////////////////////////////////////////////////////////////////////
// Initialisation de la fenêtre FEN_NouvelleCNI
////////////////////////////////////////////////////////////////////////////
public  void initialiserObjet()
{
super.setQuid(2367846239445493802l);

super.setChecksum("570542431");

super.setNom("FEN_NouvelleCNI");
...
////////////////////////////////////////////////////////////////////////////
// Initialisation des champs de FEN_NouvelleCNI
////////////////////////////////////////////////////////////////////////////
...
mWD_LIB_positionIMG.initialiserObjet();
super.ajouter("LIB_positionIMG", mWD_LIB_positionIMG);
...
{
return GWDPCapture_piece_d_identite.getInstance().mWD_FEN_NouvelleCNI;
}
}
/**
